...
#include "soapH.h"
    ...
    class SOAP_CMAC ProvisioningBindingService : public soap {
      public:
        ...
        ProvisioningBindingService(const struct soap&);
        ...
        virtual int PanMove(_ns9__PanMove *ns9__PanMove, _ns9__PanMoveResponse &ns9__PanMoveResponse) SOAP_PURE_VIRTUAL;
        /// Web service operation 'TiltMove' (returns SOAP_OK or error code)
        virtual int TiltMove(_ns9__TiltMove *ns9__TiltMove, _ns9__TiltMoveResponse &ns9__TiltMoveResponse) SOAP_PURE_VIRTUAL;
        /// Web service operation 'ZoomMove' (returns SOAP_OK or error code)
        virtual int ZoomMove(_ns9__ZoomMove *ns9__ZoomMove, _ns9__ZoomMoveResponse &ns9__ZoomMoveResponse) SOAP_PURE_VIRTUAL;
        /// Web service operation 'RollMove' (returns SOAP_OK or error code)
        virtual int RollMove(_ns9__RollMove *ns9__RollMove, _ns9__RollMoveResponse &ns9__RollMoveResponse) SOAP_PURE_VIRTUAL;
        /// Web service operation 'FocusMove' (returns SOAP_OK or error code)
        virtual int FocusMove(_ns9__FocusMove *ns9__FocusMove, _ns9__FocusMoveResponse &ns9__FocusMoveResponse) SOAP_PURE_VIRTUAL;
        /// Web service operation 'Stop' (returns SOAP_OK or error code)
        virtual int Stop(_ns9__Stop *ns9__Stop, _ns9__StopResponse &ns9__StopResponse) SOAP_PURE_VIRTUAL;
        /// Web service operation 'GetUsage' (returns SOAP_OK or error code)
        virtual int GetUsage(_ns9__GetUsage *ns9__GetUsage, _ns9__GetUsageResponse &ns9__GetUsageResponse) SOAP_PURE_VIRTUAL;
    };
#endif
