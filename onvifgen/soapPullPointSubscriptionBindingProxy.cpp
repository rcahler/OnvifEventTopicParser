...
PullPointSubscriptionBindingProxy::PullPointSubscriptionBindingProxy() : soap(SOAP_IO_DEFAULT)
...
PullPointSubscriptionBindingProxy::PullPointSubscriptionBindingProxy(const char *endpoint) : soap(SOAP_IO_DEFAULT)
{	PullPointSubscriptionBindingProxy_init(SOAP_IO_DEFAULT, SOAP_IO_DEFAULT);
	soap_endpoint = endpoint;
}

PullPointSubscriptionBindingProxy::PullPointSubscriptionBindingProxy(soap_mode iomode) : soap(iomode)
{	PullPointSubscriptionBindingProxy_init(iomode, iomode);
}

PullPointSubscriptionBindingProxy::PullPointSubscriptionBindingProxy(const char *endpoint, soap_mode iomode) : soap(iomode)
{	PullPointSubscriptionBindingProxy_init(iomode, iomode);
	soap_endpoint = endpoint;
}

PullPointSubscriptionBindingProxy::PullPointSubscriptionBindingProxy(soap_mode imode, soap_mode omode) : soap(imode, omode)
...
{	PullPointSubscriptionBindingProxy *dup = SOAP_NEW_UNMANAGED(PullPointSubscriptionBindingProxy(*(struct soap*)this));
	return dup;
}
