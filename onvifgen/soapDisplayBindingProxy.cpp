...
DisplayBindingProxy::DisplayBindingProxy() : soap(SOAP_IO_DEFAULT)
...
DisplayBindingProxy::DisplayBindingProxy(const char *endpoint) : soap(SOAP_IO_DEFAULT)
{	DisplayBindingProxy_init(SOAP_IO_DEFAULT, SOAP_IO_DEFAULT);
	soap_endpoint = endpoint;
}

DisplayBindingProxy::DisplayBindingProxy(soap_mode iomode) : soap(iomode)
{	DisplayBindingProxy_init(iomode, iomode);
}

DisplayBindingProxy::DisplayBindingProxy(const char *endpoint, soap_mode iomode) : soap(iomode)
{	DisplayBindingProxy_init(iomode, iomode);
	soap_endpoint = endpoint;
}

DisplayBindingProxy::DisplayBindingProxy(soap_mode imode, soap_mode omode) : soap(imode, omode)
...
{	DisplayBindingProxy *dup = SOAP_NEW_UNMANAGED(DisplayBindingProxy(*(struct soap*)this));
	return dup;
}
