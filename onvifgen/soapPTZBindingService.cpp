...
PTZBindingService::PTZBindingService() : soap(SOAP_IO_DEFAULT)
...
PTZBindingService::PTZBindingService(soap_mode iomode) : soap(iomode)
{	PTZBindingService_init(iomode, iomode);
}

PTZBindingService::PTZBindingService(soap_mode imode, soap_mode omode) : soap(imode, omode)
...
{	PTZBindingService *dup = SOAP_NEW_UNMANAGED(PTZBindingService(*(struct soap*)this));
	return dup;
}
#endif
...
int PTZBindingService::dispatch()
{
	...
	if (!soap_match_tag(this, this->tag, "tptz:GeoMove"))
...
static int serve___tptz__GeoMove(PTZBindingService *soap)
{	struct __tptz__GeoMove soap_tmp___tptz__GeoMove;
	...
	if (soap_body_end_in(soap)
	 ...
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = soap->GeoMove(soap_tmp___tptz__GeoMove.tptz__GeoMove, tptz__GeoMoveResponse);
	if (soap->error)
		return soap->error;
	soap->encodingStyle = NULL;
	soap_serializeheader(soap);
