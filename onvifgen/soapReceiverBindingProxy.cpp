...
ReceiverBindingProxy::ReceiverBindingProxy() : soap(SOAP_IO_DEFAULT)
...
ReceiverBindingProxy::ReceiverBindingProxy(const char *endpoint) : soap(SOAP_IO_DEFAULT)
{	ReceiverBindingProxy_init(SOAP_IO_DEFAULT, SOAP_IO_DEFAULT);
	soap_endpoint = endpoint;
}

ReceiverBindingProxy::ReceiverBindingProxy(soap_mode iomode) : soap(iomode)
{	ReceiverBindingProxy_init(iomode, iomode);
}

ReceiverBindingProxy::ReceiverBindingProxy(const char *endpoint, soap_mode iomode) : soap(iomode)
{	ReceiverBindingProxy_init(iomode, iomode);
	soap_endpoint = endpoint;
}

ReceiverBindingProxy::ReceiverBindingProxy(soap_mode imode, soap_mode omode) : soap(imode, omode)
...
{	ReceiverBindingProxy *dup = SOAP_NEW_UNMANAGED(ReceiverBindingProxy(*(struct soap*)this));
	return dup;
}
