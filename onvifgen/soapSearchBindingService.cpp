...
SearchBindingService::SearchBindingService() : soap(SOAP_IO_DEFAULT)
...
SearchBindingService::SearchBindingService(soap_mode iomode) : soap(iomode)
{	SearchBindingService_init(iomode, iomode);
}

SearchBindingService::SearchBindingService(soap_mode imode, soap_mode omode) : soap(imode, omode)
...
{	SearchBindingService *dup = SOAP_NEW_UNMANAGED(SearchBindingService(*(struct soap*)this));
	return dup;
}
#endif
