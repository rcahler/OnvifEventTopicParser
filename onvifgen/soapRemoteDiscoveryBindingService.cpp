...
RemoteDiscoveryBindingService::RemoteDiscoveryBindingService() : soap(SOAP_IO_DEFAULT)
...
RemoteDiscoveryBindingService::RemoteDiscoveryBindingService(soap_mode iomode) : soap(iomode)
{	RemoteDiscoveryBindingService_init(iomode, iomode);
}

RemoteDiscoveryBindingService::RemoteDiscoveryBindingService(soap_mode imode, soap_mode omode) : soap(imode, omode)
...
{	RemoteDiscoveryBindingService *dup = SOAP_NEW_UNMANAGED(RemoteDiscoveryBindingService(*(struct soap*)this));
	return dup;
}
#endif
...
static int serve___ns11__Hello(RemoteDiscoveryBindingService*);
static int serve___ns11__Bye(RemoteDiscoveryBindingService*);
static int serve___ns11__Probe(RemoteDiscoveryBindingService*);

int RemoteDiscoveryBindingService::dispatch()
{
	soap_peek_element(this);
	if (!soap_match_tag(this, this->tag, "ns11:Hello"))
		return serve___ns11__Hello(this);
	if (!soap_match_tag(this, this->tag, "ns11:Bye"))
		return serve___ns11__Bye(this);
	if (!soap_match_tag(this, this->tag, "ns11:Probe"))
		return serve___ns11__Probe(this);
	return this->error = SOAP_NO_METHOD;
}

static int serve___ns11__Hello(RemoteDiscoveryBindingService *soap)
{	struct __ns11__Hello soap_tmp___ns11__Hello;
	struct wsdd__ResolveType ns11__HelloResponse;
	soap_default_wsdd__ResolveType(soap, &ns11__HelloResponse);
	soap_default___ns11__Hello(soap, &soap_tmp___ns11__Hello);
	if (!soap_get___ns11__Hello(soap, &soap_tmp___ns11__Hello, "-ns11:Hello", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = soap->Hello(soap_tmp___ns11__Hello.ns11__Hello, ns11__HelloResponse);
	if (soap->error)
		return soap->error;
	soap->encodingStyle = NULL;
	soap_serializeheader(soap);
	soap_serialize_wsdd__ResolveType(soap, &ns11__HelloResponse);
	...
	{	if (soap_envelope_begin_out(soap)
		 ...
		 || soap_put_wsdd__ResolveType(soap, &ns11__HelloResponse, "ns11:HelloResponse", "")
...
static int serve___ns11__Bye(RemoteDiscoveryBindingService *soap)
{	struct __ns11__Bye soap_tmp___ns11__Bye;
	struct wsdd__ResolveType ns11__ByeResponse;
	soap_default_wsdd__ResolveType(soap, &ns11__ByeResponse);
	soap_default___ns11__Bye(soap, &soap_tmp___ns11__Bye);
	if (!soap_get___ns11__Bye(soap, &soap_tmp___ns11__Bye, "-ns11:Bye", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = soap->Bye(soap_tmp___ns11__Bye.ns11__Bye, ns11__ByeResponse);
	if (soap->error)
		return soap->error;
	soap->encodingStyle = NULL;
	soap_serializeheader(soap);
	soap_serialize_wsdd__ResolveType(soap, &ns11__ByeResponse);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put_wsdd__ResolveType(soap, &ns11__ByeResponse, "ns11:ByeResponse", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	};
...
static int serve___ns11__Probe(RemoteDiscoveryBindingService *soap)
{	struct __ns11__Probe soap_tmp___ns11__Probe;
	struct wsdd__ProbeMatchesType ns11__ProbeResponse;
	...
	if (soap_body_end_in(soap)
	 ...
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = soap->Probe(soap_tmp___ns11__Probe.ns11__Probe, ns11__ProbeResponse);
	if (soap->error)
		return soap->error;
	soap->encodingStyle = NULL;
	soap_serializeheader(soap);
	soap_serialize_wsdd__ProbeMatchesType(soap, &ns11__ProbeResponse);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put_wsdd__ProbeMatchesType(soap, &ns11__ProbeResponse, "ns11:ProbeResponse", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	};
