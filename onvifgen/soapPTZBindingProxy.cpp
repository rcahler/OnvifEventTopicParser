...
PTZBindingProxy::PTZBindingProxy() : soap(SOAP_IO_DEFAULT)
...
PTZBindingProxy::PTZBindingProxy(const char *endpoint) : soap(SOAP_IO_DEFAULT)
{	PTZBindingProxy_init(SOAP_IO_DEFAULT, SOAP_IO_DEFAULT);
	soap_endpoint = endpoint;
}

PTZBindingProxy::PTZBindingProxy(soap_mode iomode) : soap(iomode)
{	PTZBindingProxy_init(iomode, iomode);
}

PTZBindingProxy::PTZBindingProxy(const char *endpoint, soap_mode iomode) : soap(iomode)
{	PTZBindingProxy_init(iomode, iomode);
	soap_endpoint = endpoint;
}

PTZBindingProxy::PTZBindingProxy(soap_mode imode, soap_mode omode) : soap(imode, omode)
...
{	PTZBindingProxy *dup = SOAP_NEW_UNMANAGED(PTZBindingProxy(*(struct soap*)this));
	return dup;
}
