...
SearchBindingProxy::SearchBindingProxy() : soap(SOAP_IO_DEFAULT)
...
SearchBindingProxy::SearchBindingProxy(const char *endpoint) : soap(SOAP_IO_DEFAULT)
{	SearchBindingProxy_init(SOAP_IO_DEFAULT, SOAP_IO_DEFAULT);
	soap_endpoint = endpoint;
}

SearchBindingProxy::SearchBindingProxy(soap_mode iomode) : soap(iomode)
{	SearchBindingProxy_init(iomode, iomode);
}

SearchBindingProxy::SearchBindingProxy(const char *endpoint, soap_mode iomode) : soap(iomode)
{	SearchBindingProxy_init(iomode, iomode);
	soap_endpoint = endpoint;
}

SearchBindingProxy::SearchBindingProxy(soap_mode imode, soap_mode omode) : soap(imode, omode)
...
{	SearchBindingProxy *dup = SOAP_NEW_UNMANAGED(SearchBindingProxy(*(struct soap*)this));
	return dup;
}
