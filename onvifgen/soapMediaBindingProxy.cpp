...
MediaBindingProxy::MediaBindingProxy() : soap(SOAP_IO_DEFAULT)
...
MediaBindingProxy::MediaBindingProxy(const char *endpoint) : soap(SOAP_IO_DEFAULT)
{	MediaBindingProxy_init(SOAP_IO_DEFAULT, SOAP_IO_DEFAULT);
	soap_endpoint = endpoint;
}

MediaBindingProxy::MediaBindingProxy(soap_mode iomode) : soap(iomode)
{	MediaBindingProxy_init(iomode, iomode);
}

MediaBindingProxy::MediaBindingProxy(const char *endpoint, soap_mode iomode) : soap(iomode)
{	MediaBindingProxy_init(iomode, iomode);
	soap_endpoint = endpoint;
}

MediaBindingProxy::MediaBindingProxy(soap_mode imode, soap_mode omode) : soap(imode, omode)
...
{	MediaBindingProxy *dup = SOAP_NEW_UNMANAGED(MediaBindingProxy(*(struct soap*)this));
	return dup;
}
