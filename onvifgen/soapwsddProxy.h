...
#include "soapH.h"
    ...
    class SOAP_CMAC wsddProxy : public soap {
      public:
        ...
        { return soap_recv_empty_response(this); }
        ...
        {
          if (this->send_Hello(soap_endpoint, soap_action, wsdd__Hello) || soap_recv_empty_response(this))
            return this->error;
            return SOAP_OK;
        }
        ...
        {
          if (this->send_Bye(soap_endpoint, soap_action, wsdd__Bye) || soap_recv_empty_response(this))
            return this->error;
            return SOAP_OK;
        }
        ...
        {
          if (this->send_Probe(soap_endpoint, soap_action, wsdd__Probe) || soap_recv_empty_response(this))
            return this->error;
            return SOAP_OK;
        }
        ...
        {
          if (this->send_ProbeMatches(soap_endpoint, soap_action, wsdd__ProbeMatches) || soap_recv_empty_response(this))
            return this->error;
            return SOAP_OK;
        }
        ...
        {
          if (this->send_Resolve(soap_endpoint, soap_action, wsdd__Resolve) || soap_recv_empty_response(this))
            return this->error;
            return SOAP_OK;
        }
        ...
        {
          if (this->send_ResolveMatches(soap_endpoint, soap_action, wsdd__ResolveMatches) || soap_recv_empty_response(this))
            return this->error;
            return SOAP_OK;
        }
    };
