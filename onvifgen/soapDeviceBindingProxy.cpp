...
DeviceBindingProxy::DeviceBindingProxy(const char *endpoint) : soap(SOAP_IO_DEFAULT)
{	DeviceBindingProxy_init(SOAP_IO_DEFAULT, SOAP_IO_DEFAULT);
...
DeviceBindingProxy::DeviceBindingProxy(const char *endpoint, soap_mode iomode) : soap(iomode)
{	DeviceBindingProxy_init(iomode, iomode);
	soap_endpoint = endpoint;
}
