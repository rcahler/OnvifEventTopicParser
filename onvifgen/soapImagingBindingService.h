...
#include "soapH.h"
    ...
    class SOAP_CMAC ImagingBindingService : public soap {
      public:
        ...
        /// Web service operation 'GetServiceCapabilities' (returns SOAP_OK or error code)
        virtual int GetServiceCapabilities_(_timg__GetServiceCapabilities *timg__GetServiceCapabilities, _timg__GetServiceCapabilitiesResponse &timg__GetServiceCapabilitiesResponse) SOAP_PURE_VIRTUAL;
        /// Web service operation 'GetImagingSettings' (returns SOAP_OK or error code)
        virtual int GetImagingSettings_(_timg__GetImagingSettings *timg__GetImagingSettings, _timg__GetImagingSettingsResponse &timg__GetImagingSettingsResponse) SOAP_PURE_VIRTUAL;
        /// Web service operation 'SetImagingSettings' (returns SOAP_OK or error code)
        virtual int SetImagingSettings_(_timg__SetImagingSettings *timg__SetImagingSettings, _timg__SetImagingSettingsResponse &timg__SetImagingSettingsResponse) SOAP_PURE_VIRTUAL;
        /// Web service operation 'GetOptions' (returns SOAP_OK or error code)
        virtual int GetOptions_(_timg__GetOptions *timg__GetOptions, _timg__GetOptionsResponse &timg__GetOptionsResponse) SOAP_PURE_VIRTUAL;
        /// Web service operation 'Move' (returns SOAP_OK or error code)
        virtual int Move_(_timg__Move *timg__Move, _timg__MoveResponse &timg__MoveResponse) SOAP_PURE_VIRTUAL;
        /// Web service operation 'Stop' (returns SOAP_OK or error code)
        virtual int Stop_(_timg__Stop *timg__Stop, _timg__StopResponse &timg__StopResponse) SOAP_PURE_VIRTUAL;
        /// Web service operation 'GetStatus' (returns SOAP_OK or error code)
        virtual int GetStatus_(_timg__GetStatus *timg__GetStatus, _timg__GetStatusResponse &timg__GetStatusResponse) SOAP_PURE_VIRTUAL;
        /// Web service operation 'GetMoveOptions' (returns SOAP_OK or error code)
        virtual int GetMoveOptions_(_timg__GetMoveOptions *timg__GetMoveOptions, _timg__GetMoveOptionsResponse &timg__GetMoveOptionsResponse) SOAP_PURE_VIRTUAL;
    };
#endif
