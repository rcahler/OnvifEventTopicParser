...
ReplayBindingProxy::ReplayBindingProxy() : soap(SOAP_IO_DEFAULT)
...
ReplayBindingProxy::ReplayBindingProxy(const char *endpoint) : soap(SOAP_IO_DEFAULT)
{	ReplayBindingProxy_init(SOAP_IO_DEFAULT, SOAP_IO_DEFAULT);
	soap_endpoint = endpoint;
}

ReplayBindingProxy::ReplayBindingProxy(soap_mode iomode) : soap(iomode)
{	ReplayBindingProxy_init(iomode, iomode);
}

ReplayBindingProxy::ReplayBindingProxy(const char *endpoint, soap_mode iomode) : soap(iomode)
{	ReplayBindingProxy_init(iomode, iomode);
	soap_endpoint = endpoint;
}

ReplayBindingProxy::ReplayBindingProxy(soap_mode imode, soap_mode omode) : soap(imode, omode)
...
{	ReplayBindingProxy *dup = SOAP_NEW_UNMANAGED(ReplayBindingProxy(*(struct soap*)this));
	return dup;
}
