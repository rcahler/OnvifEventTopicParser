...
#include "soapH.h"
    ...
    class SOAP_CMAC PullPointSubscriptionBindingProxy : public soap {
      public:
        ...
        {
          if (this->send_Notify(soap_endpoint, soap_action, wsnt__Notify) || soap_recv_empty_response(this))
            return this->error;
            return SOAP_OK;
        }
        ...
        {
          if (this->send_Notify_(soap_endpoint, soap_action, wsnt__Notify) || soap_recv_empty_response(this))
            return this->error;
            return SOAP_OK;
        }
