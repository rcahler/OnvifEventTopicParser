...
RecordingBindingProxy::RecordingBindingProxy() : soap(SOAP_IO_DEFAULT)
...
RecordingBindingProxy::RecordingBindingProxy(const char *endpoint) : soap(SOAP_IO_DEFAULT)
{	RecordingBindingProxy_init(SOAP_IO_DEFAULT, SOAP_IO_DEFAULT);
	soap_endpoint = endpoint;
}

RecordingBindingProxy::RecordingBindingProxy(soap_mode iomode) : soap(iomode)
{	RecordingBindingProxy_init(iomode, iomode);
}

RecordingBindingProxy::RecordingBindingProxy(const char *endpoint, soap_mode iomode) : soap(iomode)
{	RecordingBindingProxy_init(iomode, iomode);
	soap_endpoint = endpoint;
}

RecordingBindingProxy::RecordingBindingProxy(soap_mode imode, soap_mode omode) : soap(imode, omode)
...
{	RecordingBindingProxy *dup = SOAP_NEW_UNMANAGED(RecordingBindingProxy(*(struct soap*)this));
	return dup;
}
