...
#include "soapH.h"
    ...
    class SOAP_CMAC ReplayBindingService : public soap {
      public:
        ...
        /// Copy constructor
        ReplayBindingService(const ReplayBindingService&);
        ...
        virtual ReplayBindingService *copy() SOAP_PURE_VIRTUAL_COPY;
        /// Copy assignment
        ReplayBindingService& operator=(const ReplayBindingService&);
