...
#include "soapH.h"
    ...
    class SOAP_CMAC RemoteDiscoveryBindingService : public soap {
      public:
        ...
        virtual int Hello(const struct wsdd__HelloType& ns11__Hello, struct wsdd__ResolveType &ns11__HelloResponse) SOAP_PURE_VIRTUAL;
        /// Web service operation 'Bye' (returns SOAP_OK or error code)
        virtual int Bye(const struct wsdd__ByeType& ns11__Bye, struct wsdd__ResolveType &ns11__ByeResponse) SOAP_PURE_VIRTUAL;
        /// Web service operation 'Probe' (returns SOAP_OK or error code)
        virtual int Probe(const struct wsdd__ProbeType& ns11__Probe, struct wsdd__ProbeMatchesType &ns11__ProbeResponse) SOAP_PURE_VIRTUAL;
    };
#endif
